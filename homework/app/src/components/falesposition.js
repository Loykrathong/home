...
class falseposition extends Component {
  ...
  constructor() {
    super();
    this.state = { item: [], check: false, Xr: 0, Xl: 0, Xm: 0,function: " "  }
  ...
  onSubmit() {
    if (this.state.Xl < this.state.Xr) {
      ...
      xm = ((inputy['xl'][n] * fxr[n]) - (inputy['xr'][n] * fxl[n])) / (fxr[n] - fxl[n])
      inputy['xm'][n] = xm
      inputy['error'][n] = 1
      ...
      do {
        ...
        xm = ((inputy['xl'][n + 1] * fxr[n + 1]) - (inputy['xr'][n + 1] * fxl[n + 1])) / (fxr[n + 1] - fxl[n + 1])
        ...
        >
          <Form>
            ...
            <div>        
              ...
              <Button variant="secondary" href="/falseposition">Reset</Button>
