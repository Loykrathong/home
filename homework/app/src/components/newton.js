...
class newton extends Component {
    ...
    onSubmit() {
        if (this.state.function != " ") {
            ...
            inputy['x+1'][n] = (inputy['x'][n] -(this.funcChange(x)/this.funcDiff(x)))
            xnew = inputy['x+1'][n]
            inputy['error'][n] = 1
            n++;
            ...
            do {
                inputy['x'][n] = xnew
                inputy['x+1'][n] = (inputy['x'][n] -(this.funcChange(xnew)/this.funcDiff(xnew)))
                xnew = inputy['x+1'][n]
        ...
        return (
            <Layout style={{ padding: '0 24px 24px' }}>
                <Breadcrumb style={{ margin: '16px 0' }}>
                    <Breadcrumb.Item>Newton-raphson {this.state.function}</Breadcrumb.Item>
                </Breadcrumb>
                <Content
                ...
                >
                    <Form>
                        ...
                        <div>
                            ...
                            <Button variant="secondary" href="/newton">Reset</Button>
